...
class AddProductCubit extends Cubit<AddProductState> {
  ...
  Future updateField(
    ...
    try {
      await firebaseFirestore
        ...
        customToast(msg: '$field has been updated', color: AppColors.mainColor);
      });
    } catch (e) {
      print(e);
      customToast(msg: 'Something went wrong ', color: Colors.red);
  ...
  updateFieldsProduct(
    ...
    try {
      await firebaseFirestore.collection('products').doc(id).update({
        ...
        customToast(msg: 'data has been updated', color: AppColors.mainColor);
        emit(AddProductSuccess());
      });
    } catch (e) {
      emit(AddProductFailed());
  ...
  updateImages(
      {required List<String> imagesLinks,
  ...
  deleteProduct({required String id}) async {
    try {
      await firebaseFirestore
          ...
          .delete()
          .whenComplete(() {
            customToast(msg: 'product has been deleted', color: AppColors.mainColor);
      });
    } catch (e) {
      customToast(msg: 'can not delete', color: Colors.red);
